...
import com.portfolio.MZ.Dto.dtoExperiencia;
import com.portfolio.MZ.Entity.Experiencia;
import com.portfolio.MZ.Security.Controller.Mensaje;
import com.portfolio.MZ.Service.SExperiencia;
...
@CrossOrigin(origins = {"http://localhost:4200", "https://mz-frontend.web.app"})
/**
 *
 * @author Mateo
 */
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getDescripcionE(), dtoexp.getImagenE());
